...
/**
 * Connection type - can be org to athlete or coach to organization
 */
export type ConnectionType = 'org_to_athlete' | 'coach_to_org';
...
export interface OrganizationConnection {
  ...
  // Sender info (organization or coach)
  senderId: string;
  senderName: string;
  senderPhotoURL: string;
  senderRole: 'organization' | 'coach';

  // Recipient info (athlete or organization)
  recipientId: string;
